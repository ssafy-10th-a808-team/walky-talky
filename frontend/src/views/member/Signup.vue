    ...
    <form>
      <fieldset>
        ...
        <div class="row g-3 align-items-center">
          ...
          <div class="col-auto">
            <input v-model="member.id" type="text" class="form-control" style="width: 18rem" />
          </div>
          <div class="col-auto">
        ...
        <div class="row g-3 align-items-center">
          ...
          <div class="form-check,col-auto" style="text-align: left; margin-left: 50px">
            <input v-model="member.gender" class="form-check-input" type="radio" value="F" />&nbsp;
...
안녕하세요. </textarea
    ...
    <div class="row g-3 align-items-center">
      ...
      <div class="col-auto">
        <button type="submit" class="btn btn-outline-primary" @click="createMember">
          회원가입
        </button>
      </div>
    </div>
